...
export function Form(){
    ...
    return(
        <form className="flex w-80 flex-col gap-3 rounded-lg border border-slate-700 bg-slate-800 p-8 shadow-lg mx-auto mt-8">
            ...
            <button onClick={() => handleSubmit(email, password)} type="submit" className="mt-2 rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white hover:bg-blue-700">Login</button>
        </form>
    );
}
